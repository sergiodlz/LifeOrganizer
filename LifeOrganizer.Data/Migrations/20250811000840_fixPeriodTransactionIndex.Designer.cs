...
namespace LifeOrganizer.Data.Migrations
{
    ...
    [Migration("20250811000840_fixPeriodTransactionIndex")]
    partial class fixPeriodTransactionIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeOrganizer.Data.Entities.BudgetPeriodTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BudgetPeriodId", "TransactionId", "IsDeleted")
                        .IsUnique();

                    b.ToTable("BudgetPeriodTransaction");
                });
            ...
            modelBuilder.Entity("LifeOrganizer.Data.Entities.BudgetPeriodTransaction", b =>
                {
                    b.HasOne("LifeOrganizer.Data.Entities.BudgetPeriod", "BudgetPeriod")
                        .WithMany("BudgetPeriodTransactions")
                        .HasForeignKey("BudgetPeriodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LifeOrganizer.Data.Entities.Transaction", "Transaction")
                        .WithMany("BudgetPeriodTransactions")
            ...
            modelBuilder.Entity("LifeOrganizer.Data.Entities.BudgetPeriod", b =>
                {
                    b.Navigation("BudgetPeriodTransactions");
                });
